...
<html lang="en" dir="ltr">
  ...
  <link href="<?= base_url() ?>public/assets/bootstrap/plugins/jvectormap/jquery-jvectormap-2.0.3.css" rel="stylesheet" />
  
  
  
  <link href="<?= base_url() ?>public/assets/bootstrap/plugins/daterangepicker/daterangepicker.css" rel="stylesheet" />
  ...
  <link href="<?= base_url() ?>public/assets/bootstrap/plugins/toaster/toastr.min.css" rel="stylesheet" />
  
  
  <!-- MONO CSS -->
  <link  rel="stylesheet" href="<?= base_url() ?>public/assets/bootstrap/css/style.css" />
  <link  rel="stylesheet" href="<?= base_url() ?>public/assets/bootstrap/css/font.css" />
                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown user-menu">
                    <button class="dropdown-toggle nav-link" data-toggle="dropdown">
                      ...
                      <span class="d-none d-lg-inline-block"><?= session()->get('user_name'); ?></span>
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                      <li>
                        <a class="dropdown-link-item" href="<?= base_url() ?>public/dashboard/profile">
                      ...
                      <li class="dropdown-footer">
                        <a class="dropdown-link-item" href="<?= base_url()?>public/dashboard/logout"> <i class="mdi mdi-logout"></i> Log Out </a>
                      </li>
                    </ul>
                  </li>
                </ul>
                      ...
                      <div class="card card-default chat">
                        ...
                        <div class="card-body pb-0" data-simplebar style="height: 363px;">
                          ...
                          <div class="media media-chat">
                            <img src="<?= base_url() ?>public/assets/bootstrap/images/user/user-sm-01.jpg" class="rounded-circle" alt="Avata Image">
                            <div class="media-body">
                          ...
                          <div class="media media-chat media-chat-right">
                            ...
                            <img src="<?= base_url() ?>public/assets/bootstrap/images/user/user-sm-02.jpg" class="rounded-circle" alt="Avata Image">
                          </div>
          ...
          <footer class="footer mt-auto">
            ...
            <script>
                ...
                document.getElementById("copy-year").innerHTML = year;
                    ...
                    <script src="<?= base_url() ?>public/assets/bootstrap/plugins/jvectormap/jquery-jvectormap-2.0.3.min.js"></script>
                    <script src="<?= base_url() ?>public/assets/bootstrap/plugins/jvectormap/jquery-jvectormap-world-mill.js"></script>
                    <script src="<?= base_url() ?>public/assets/bootstrap/plugins/jvectormap/jquery-jvectormap-us-aea.js"></script>
                    
                    
                    
                    <script src="<?= base_url() ?>public/assets/bootstrap/plugins/daterangepicker/moment.min.js"></script>
                    <script src="<?= base_url() ?>public/assets/bootstrap/plugins/daterangepicker/daterangepicker.js"></script>
                    <script>
                    ...
                    <script src="<?= base_url() ?>public/assets/bootstrap/plugins/toaster/toastr.min.js"></script>

                    
                    
                    <script src="<?= base_url() ?>public/assets/bootstrap/js/mono.js"></script>
                    <script src="<?= base_url() ?>public/assets/bootstrap/js/chart.js"></script>
                    <script src="<?= base_url() ?>public/assets/bootstrap/js/map.js"></script>
                    <script src="<?= base_url() ?>public/assets/bootstrap/js/custom.js"></script>
